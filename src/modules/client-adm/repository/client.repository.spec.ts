...
describe('Client Repository test', () => {
  ...
  it('should create a client', async () => {
    ...
    expect(clientDb.document).toEqual(
      client.document
    )
    expect(clientDb.street).toEqual(
      client.address.street
    )
    expect(clientDb.number).toEqual(
      client.address.number
    )
    expect(clientDb.complement).toEqual(
      client.address.complement
    )
    expect(clientDb.city).toEqual(
      client.address.city
    )
    expect(clientDb.state).toEqual(
      client.address.state
    )
    expect(clientDb.zipcode).toEqual(
      client.address.zipCode
    )
    expect(clientDb.createdAt).toStrictEqual(
      client.createdAt
    )
    expect(clientDb.updatedAt).toStrictEqual(
      client.updatedAt
    )
  })
  ...
  it('should find a client', async () => {
    ...
    expect(result.updatedAt).toStrictEqual(
      client.updatedAt
    )
  })
  ...
  it('should find all clients', async () => {
    ...
    expect(result[0].id.id).toEqual(client.id)
    ...
    expect(result[0].updatedAt).toStrictEqual(
      client.updatedAt
    )
  })
})
